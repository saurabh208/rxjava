...
public class PatientServiceImpl implements PatientService {
    ...
    public Mono<PatientDTO> createPatient(PatientDTO body) {
        /**
    ...
    public Flux<PatientDTO> getPatient(String medicalRecordNumber) {
        /**
         * This is the data layer and the idea here is to check the mandatory parameters
         * if not return an empty result. Throwing an exception from here is bad for
         * performance because it has to travel through more than one layers
    ...
    public Flux<PatientDTO> searchPatients(String lastName, String firstName, int page, int size) {
        /**
         * This is the data layer and the idea here is to check the mandatory parameters
         * if not return an empty result. Throwing an exception from here is bad for
         * performance because it has to travel through more than one layers
    ...
    public Mono<PatientDTO> savePatient(String medicalRecordNumber, PatientDTO patientDTO) {
        /**
         * This is the data layer and the idea here is to check the mandatory parameters
         * if not return an empty result. Throwing an exception from here is bad for
         * performance because it has to travel through more than one layers
         ...
         * Only the mandatory exceptions must be thrown back it must be the last resort
         */
        LOG.debug("Saving patient details with medicalRecordNumber:{}", medicalRecordNumber);
        return null;
    }

    public Mono<Void> deletePatient(String medicalRecordNumber) {
        return null;
    }
